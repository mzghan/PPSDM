...
<head>
  ...
  <link href="../assets/demo/templateUnit.css" rel="stylesheet" />
</head>
              ...
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">Pendaftar Magang</p>
                      <p class="card-title">{{ $mandiris->count() }} Peserta<p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  ...
                  <div class="col-12 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title">{{ $wawancaras->count() }} Peserta<p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">Pendaftar Posting</p>
                      <p class="card-title">{{ $postings->count() }} Peserta<p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">Laporan diterima</p>
                      <p class="card-title">{{ $jumlah_laporan_diterima }} Peserta</p>
                    </div>
                  </div>
                </div>
              </div>
