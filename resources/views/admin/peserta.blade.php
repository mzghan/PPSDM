...
<head>
  ...
  <title>Data Peserta - Admin BPOM</title>
 <!--     Fonts and icons     -->
  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Admin - Data Peserta</a>
          </div>
      ...
      <div class="content">
            ...
            <div class="button">
                  <a href="{{ route('export.peserta') }}" class="btn btn-success">Export to Excel</a>
              </div>
            <div class="card">
